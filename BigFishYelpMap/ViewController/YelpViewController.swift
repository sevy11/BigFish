...
class YelpViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    @IBOutlet private weak var restaurantViewToTopConstraint: NSLayoutConstraint!
    ...
    func setRestaurantView(restaurant: Restaurant) {
        ...
        ratingLabel.text = String(format: "\(restaurant.rating) stars") // restaurant.ratingLabel stars
    }
